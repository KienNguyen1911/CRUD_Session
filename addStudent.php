                ...
                <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="date" class="form-control" id="validationCustomUsername" name="birthday" aria-describedby="inputGroupPrepend" required>
                    ...
                    <div class="col-md-12" style="display: flex; flex-direction: column">
                        ...
                        <input type="file" class="form-control" id="inputGroupFile01" name="image" required onchange="loadFile(event)">
                        <div class="invalid-feedback">
                            <?php
                            echo $imageErr
                            ?>
